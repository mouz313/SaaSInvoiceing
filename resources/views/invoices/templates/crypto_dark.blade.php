...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Courier New', Courier, monospace; }
        ...
        .terminal-header { border-bottom: 2px solid #10b981; padding-bottom: 16px; margin-bottom: 22px; }
        .badge { display: inline-block; padding: 2px 8px; border-radius: 2px; font-size: 10px; font-weight: 800; text-transform: uppercase; background: #10b981; color: #020617; }
        .code-box { border: 1px dashed #10b981; padding: 12px; border-radius: 4px; background: rgba(15, 23, 42, 0.6); margin-bottom: 20px; }
        .table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        .table th { border-bottom: 2px solid #10b981; padding: 8px 6px; text-align: left; font-size: 10px; color: #10b981; text-transform: uppercase; }
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="vertical-align: top; width: 60%;">
                    <div style="font-size: 10px; color: #10b981; font-weight: 800; letter-spacing: 1px;">[SYSTEM_PROTOCOL: INVOICE_V2]</div>
                ...
                <td style="vertical-align: top; width: 40%; text-align: right;">
                    <div style="font-size: 24px; font-weight: 900; color: #10b981;">#{{ $invoice->invoice_number }}</div>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 50%; vertical-align: top;">
                    <div style="font-size: 9px; color: #10b981; text-transform: uppercase; font-weight: bold;">[CLIENT_NODE]</div>
                ...
                <td style="width: 50%; vertical-align: top; text-align: right;">
                    <div style="font-size: 9px; color: #10b981; text-transform: uppercase; font-weight: bold;">[SETTLEMENT_PARAMETERS]</div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right; color: #10b981; font-weight: bold;">{{ number_format($item->amount, 2) }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 25px;">
        <tr>
            <td style="width: 60%; vertical-align: middle;">
                <div style="color: #10b981; font-size: 9px;">*** CRYPTOGRAPHICALLY VALIDATED INVOICE SPECIFICATION ***</div>
            ...
            <td style="width: 40%; vertical-align: top; text-align: right;">
                ...
                @endif
                <div style="font-size: 16px; font-weight: 900; color: #10b981; margin-top: 6px; border-top: 1px solid #10b981; padding-top: 6px;">
