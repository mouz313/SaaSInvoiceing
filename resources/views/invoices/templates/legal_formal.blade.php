...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Georgia', Times, serif; }
        ...
        .certificate-border { border: 3px double #312e81; padding: 25px; }
        .badge { display: inline-block; padding: 4px 10px; font-size: 9px; font-weight: 700; text-transform: uppercase; background: #312e81; color: #ffffff; letter-spacing: 1px; }
        .table { width: 100%; border-collapse: collapse; margin-top: 15px; }
        .table th { border-bottom: 2px solid #312e81; border-top: 1px solid #312e81; padding: 7px 5px; text-align: left; font-size: 9px; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; color: #312e81; }
...
<body>
    <div class="certificate-border">
            ...
            <tr>
                <td style="vertical-align: top; width: 55%;">
                    ...
                    <div style="height: 55px; max-height: 55px; width: 180px; overflow: hidden; margin-bottom: 8px;">
                        ...
                        @else
                            <div style="font-size: 20px; font-weight: 800; color: #312e81; letter-spacing: 1px;">{{ strtoupper($invoice->user->company_name ?? $invoice->user->name) }}</div>
                ...
                <td style="vertical-align: top; width: 45%; text-align: right;">
                    <div style="font-size: 22px; font-weight: 900; color: #312e81; letter-spacing: 2px;">INVOICE</div>
                    <div style="font-size: 9px; color: #64748b; font-style: italic; margin-bottom: 4px;">Advocates & Legal Counsel Fee Notice</div>
        ...
        <div style="background: #f8fafc; border: 1px solid #e2e8f0; padding: 12px; margin-bottom: 18px;">
            ...
            <div style="font-size: 13px; font-weight: bold; color: #312e81;">{{ $invoice->client->name }}</div>
            ...
            <tr>
                ...
                <td style="width: 50%; vertical-align: top; text-align: right;">
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        @endif
                        <tr style="border-top: 2px solid #312e81; border-bottom: 2px solid #312e81;">
                            <td style="text-align: right; padding: 6px 0; font-size: 13px; font-weight: 900; color: #312e81;">Total Due:</td>
                            <td style="text-align: right; padding: 6px 0; font-size: 14px; font-weight: 900; color: #312e81;">{{ $invoice->currency }} {{ number_format($invoice->total, 2) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
...
<div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-12 border-4 border-double border-slate-300 dark:border-slate-700 shadow-xl relative overflow-hidden">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-8 border-b-2 border-slate-200 dark:border-slate-800 gap-6">
        ...
        <div class="sm:text-right space-y-1">
            ...
            <p class="text-[11px] font-serif italic text-slate-500 dark:text-slate-400">Advocates & Legal Counsel Fee Notice</p>
