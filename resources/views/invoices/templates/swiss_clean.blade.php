...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; }
        ...
        .badge { display: inline-block; padding: 3px 8px; font-size: 9px; font-weight: 800; text-transform: uppercase; background: #dc2626; color: #ffffff; }
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="vertical-align: top; width: 40%; text-align: right;">
                    ...
                    <div style="font-size: 10px; color: #dc2626; font-weight: 700; text-transform: uppercase;">Swiss International Typographic Style</div>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <tr>
            ...
            <td style="width: 45%; vertical-align: top; text-align: right;">
                ...
                @endif
                <div style="font-size: 16px; font-weight: 900; color: #dc2626; margin-top: 4px; border-top: 2px solid #0f172a; padding-top: 4px;">
...
<div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-md">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-6 border-b-2 border-slate-900 dark:border-white gap-6">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <div class="w-6 h-6 bg-red-600 text-white flex items-center justify-center font-bold text-sm shadow-xs"><svg class="w-4 h-4" viewBox="0 0 24 24" fill="white"><rect x="10" y="4" width="4" height="16"/><rect x="4" y="10" width="16" height="4"/></svg></div>
                <!-- Dedicated Logo Frame -->
        ...
        <div class="sm:text-right space-y-1">
            ...
            <span class="text-[11px] font-bold uppercase tracking-wider text-slate-400 block">Swiss International Typographic Style</span>
    ...
    <svg class="w-24 h-24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="46" stroke="#dc2626" stroke-width="2" stroke-dasharray="3 2" />
        <circle cx="50" cy="50" r="40" stroke="#dc2626" stroke-width="1.5" />
        <circle cx="50" cy="50" r="16" fill="#dc2626" fill-opacity="0.08" stroke="#dc2626" stroke-width="1" />
        <text x="50" y="44" font-size="6.5" font-weight="900" text-anchor="middle" fill="#dc2626" letter-spacing="1">VERIFIED</text>
        <text x="50" y="54" font-size="8" font-weight="900" text-anchor="middle" fill="#dc2626" letter-spacing="0.5">VERIFIED</text>
        <text x="50" y="63" font-size="5.5" font-weight="800" text-anchor="middle" fill="#dc2626">★ AUTHENTIC ★</text>
    </svg>
</div>
    ...
    <div class="w-40 border-t border-slate-300 dark:border-slate-700 pt-1">
        ...
        <div class="w-full sm:w-72 bg-slate-50 dark:bg-slate-800/60 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2 text-xs">
            ...
            <div class="pt-2 border-t border-slate-200 dark:border-slate-700 flex justify-between items-baseline text-sm">
                ...
                <span class="text-xl font-black text-slate-900 dark:text-white" style="color: #dc2626;">{{ $invoice->currency }} {{ number_format($invoice->total, 2) }}</span>
            </div>
        </div>
    </div>
</div>
