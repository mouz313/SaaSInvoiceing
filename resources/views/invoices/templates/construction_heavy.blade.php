...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Consolas', 'Courier New', monospace; }
        ...
        .blueprint-frame { border: 2px solid #d97706; padding: 18px; }
        .badge { display: inline-block; padding: 2px 6px; font-size: 9px; font-weight: 900; background: #d97706; color: #ffffff; text-transform: uppercase; }
...
<body>
    <div class="blueprint-frame">
        <table style="width: 100%; border-collapse: collapse; border-bottom: 2px solid #d97706; padding-bottom: 12px; margin-bottom: 15px;">
            <tr>
                <td style="vertical-align: top; width: 60%;">
                    <div style="font-size: 8px; font-weight: 900; color: #d97706;">[CAD DRAWING / BILLING SHEET: REV-A]</div>
                    ...
                    <div style="height: 50px; max-height: 50px; width: 180px; overflow: hidden; margin: 6px 0;">
                        ...
                        @else
                            <div style="font-size: 18px; font-weight: 900; color: #d97706;">{{ strtoupper($invoice->user->company_name ?? $invoice->user->name) }}</div>
                        @endif
                    </div>
                ...
                <td style="vertical-align: top; width: 40%; text-align: right;">
                    ...
                    <div style="font-size: 16px; font-weight: 900; color: #d97706; margin-top: 3px;">REF: {{ $invoice->invoice_number }}</div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px; border: 1px solid #cbd5e1; background: #f8fafc;">
            <tr>
                <td style="padding: 10px; width: 50%; vertical-align: top; border-right: 1px solid #cbd5e1;">
                    <div style="font-size: 8px; font-weight: 900; color: #d97706;">[CONTRACTOR / CLIENT]</div>
                ...
                <td style="padding: 10px; width: 50%; vertical-align: top;">
                    <div style="font-size: 8px; font-weight: 900; color: #d97706;">[SETTLEMENT INSTRUCTIONS]</div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
            <tr>
                <td style="width: 55%; vertical-align: bottom;">
                    <div style="border: 2px dashed #d97706; padding: 6px; width: 180px; text-align: center;">
                        <span style="font-size: 9px; font-weight: 900; color: #d97706;">APPROVED FOR PAYMENT</span>
                    </div>
                </td>
                <td style="width: 45%; vertical-align: top; text-align: right;">
                    ...
                    @endif
                    <div style="font-size: 14px; font-weight: 900; color: #d97706; margin-top: 4px; border-top: 2px solid #d97706; padding-top: 4px;">
...
<div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-10 border-2 border-slate-900 dark:border-slate-700 shadow-xl font-mono relative overflow-hidden">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-6 border-b-2 border-slate-900 dark:border-slate-700 gap-6">
        ...
        <div class="sm:text-right space-y-1">
            ...
            <p class="text-[11px] text-slate-400">Jobsite Contractor Work Order & Invoice</p>
