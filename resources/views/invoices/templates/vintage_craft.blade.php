...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; }
        ...
        .header { border-bottom: 3px solid #92400e; padding-bottom: 15px; margin-bottom: 20px; }
        .badge { display: inline-block; padding: 3px 8px; font-size: 9px; font-weight: 800; text-transform: uppercase; background: #92400e; color: #ffffff; }
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="vertical-align: top; width: 40%; text-align: right;">
                    ...
                    <div style="font-size: 10px; color: #92400e; font-weight: 700; text-transform: uppercase;">Artisanal Heritage Workshop Bill</div>
    ...
    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
        <tr>
            ...
            <td style="width: 45%; vertical-align: top; text-align: right;">
                ...
                @endif
                <div style="font-size: 16px; font-weight: 900; color: #92400e; margin-top: 4px; border-top: 2px solid #0f172a; padding-top: 4px;">
...
<div class="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-md">
    ...
    <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-6 border-b-2 border-slate-900 dark:border-white gap-6">
        ...
        <div class="sm:text-right space-y-1">
            ...
            <span class="text-[11px] font-bold uppercase tracking-wider text-slate-400 block">Artisanal Heritage Workshop Bill</span>
    ...
    <svg class="w-24 h-24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="46" stroke="#92400e" stroke-width="2" stroke-dasharray="3 2" />
        <circle cx="50" cy="50" r="40" stroke="#92400e" stroke-width="1.5" />
        <circle cx="50" cy="50" r="16" fill="#92400e" fill-opacity="0.08" stroke="#92400e" stroke-width="1" />
        <text x="50" y="44" font-size="6.5" font-weight="900" text-anchor="middle" fill="#92400e" letter-spacing="1">VERIFIED</text>
        <text x="50" y="54" font-size="8" font-weight="900" text-anchor="middle" fill="#92400e" letter-spacing="0.5">VERIFIED</text>
        <text x="50" y="63" font-size="5.5" font-weight="800" text-anchor="middle" fill="#92400e">★ AUTHENTIC ★</text>
    </svg>
</div>
    ...
    <div class="w-40 border-t border-slate-300 dark:border-slate-700 pt-1">
        ...
        <div class="w-full sm:w-72 bg-slate-50 dark:bg-slate-800/60 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 space-y-2 text-xs">
            ...
            <div class="pt-2 border-t border-slate-200 dark:border-slate-700 flex justify-between items-baseline text-sm">
                ...
                <span class="text-xl font-black text-slate-900 dark:text-white" style="color: #92400e;">{{ $invoice->currency }} {{ number_format($invoice->total, 2) }}</span>
            </div>
        </div>
    </div>
</div>
