...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', sans-serif; }
        ...
        .sidebar { width: 32%; background: #0f172a; color: #f8fafc; padding: 30px 22px; vertical-align: top; }
        .main-content { width: 68%; background: #ffffff; padding: 30px 26px; vertical-align: top; }
        .badge { display: inline-block; padding: 3px 8px; border-radius: 4px; font-size: 9px; font-weight: 800; text-transform: uppercase; background: #0ea5e9; color: #ffffff; }
        ...
        <tr>
            ...
            <td class="sidebar">
                ...
                <div style="height: 60px; max-height: 60px; width: 100%; overflow: hidden; margin-bottom: 16px;">
                    ...
                    @else
                        <div style="font-size: 18px; font-weight: 900; color: #0ea5e9; letter-spacing: -0.5px;">{{ strtoupper(substr($invoice->user->company_name ?? $invoice->user->name, 0, 16)) }}</div>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                    <tr>
                        <td style="vertical-align: top;">
                            ...
                            <div style="font-size: 10px; color: #64748b; font-weight: 700; text-transform: uppercase;">Nordic Serene Minimal Statement</div>
                        </td>
                        ...
                        <td style="width: 50%; vertical-align: top;">
                            <table style="width: 100%; border-collapse: collapse;">
                                ...
                                <tr style="border-top: 2px solid #e2e8f0;">
                                    ...
                                    <td style="padding: 8px 0 0; font-size: 15px; font-weight: 900; color: #0ea5e9; text-align: right;">{{ $invoice->currency }} {{ number_format($invoice->total, 2) }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
...
<div class="flex flex-col md:flex-row min-h-[640px] bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-sm">
        ...
        <div>
            ...
            <div class="flex flex-col sm:flex-row sm:items-start justify-between pb-6 border-b border-slate-200 dark:border-slate-800 gap-4">
                <div>
                    ...
                    <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mt-1">Nordic Serene Minimal Statement</p>
                </div>
    ...
    <svg class="w-24 h-24" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        <circle cx="50" cy="50" r="46" stroke="#0ea5e9" stroke-width="2" stroke-dasharray="3 2" />
        <circle cx="50" cy="50" r="40" stroke="#0ea5e9" stroke-width="1.5" />
        <circle cx="50" cy="50" r="16" fill="#0ea5e9" fill-opacity="0.08" stroke="#0ea5e9" stroke-width="1" />
        <text x="50" y="44" font-size="6.5" font-weight="900" text-anchor="middle" fill="#0ea5e9" letter-spacing="1">OFFICIAL INVOICE</text>
        <text x="50" y="54" font-size="8" font-weight="900" text-anchor="middle" fill="#0ea5e9" letter-spacing="0.5">VERIFIED</text>
        <text x="50" y="63" font-size="5.5" font-weight="800" text-anchor="middle" fill="#0ea5e9">★ AUTHENTIC ★</text>
    </svg>
</div>
                <div>
