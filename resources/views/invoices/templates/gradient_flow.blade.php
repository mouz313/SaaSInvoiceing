        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="vertical-align: middle; width: 60%;">
                    ...
                    <div style="font-size: 10px; opacity: 0.85; margin-top: 3px;">Digital Product & Web3 Billing</div>
                </td>
...
<div class="bg-white dark:bg-slate-900 rounded-3xl overflow-hidden shadow-xl border border-slate-200 dark:border-slate-800">
    ...
    <div class="relative bg-gradient-to-r from-fuchsia-600 via-purple-600 to-cyan-500 p-8 sm:p-10 text-white">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-6 relative z-10">
            <div>
                ...
                <p class="text-xs text-white/80 mt-1">Digital Product & Web3 Billing</p>
            </div>
